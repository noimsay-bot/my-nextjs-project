...
-- Bootstrap administrators by verified auth.users.id through a trusted operator.
-- Never infer privileges from a self-selected login_id or other user metadata.
